    ...
    <main className="mx-auto min-h-[820px] max-w-7xl px-6 py-14 sm:py-20">
      <section className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <Link href="/admin/customers" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/10 px-5 font-black">Customers</Link>
          <Link href="/admin/announcements" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/10 px-5 font-black">Announcements</Link>
          <Link href="/admin/automation" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/10 px-5 font-black">Automation</Link>
          <Link href="/admin/fraud" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/10 px-5 font-black">Fraud review</Link>
          <button
            onClick={exportCsv}
